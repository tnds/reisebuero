...
Contacttype.create(name: 'address', text: true)
User.create(username: 'anon', password: 'password',password_confirmation: 'password' , email: 'reisebuero@piraten-nds.de', disabled: true)
